...
namespace Prism.Events
{
    ...
    ///</summary>
    public class AsyncDispatcherEventSubscription : AsyncEventSubscription
	{
    ...
    public class AsyncDispatcherEventSubscription<TPayload> : AsyncEventSubscription<TPayload>
	{
		private readonly SynchronizationContext syncContext;
