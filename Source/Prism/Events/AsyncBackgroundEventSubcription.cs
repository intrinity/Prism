...
namespace Prism.Events
{
    ...
    /// </summary>
    public class AsyncBackgroundEventSubscription : AsyncEventSubscription
	{
		/// <summary>
    ...
    public class AsyncBackgroundEventSubscription<TPayload> : AsyncEventSubscription<TPayload>
	{
		/// <summary>
